...
contract BridgeContractTest is Test {
    ...
    function testBridge_InsufficientAllowance() public {
        ...
        vm.expectRevert(BridgeContract.BridgeContract_Insufficient_Allowance.selector);
        bridgeContract.bridge(token, amount);
    }
    ...
    function testBridge_TransferFailed() public {
        ...
        vm.prank(user);
        vm.expectRevert(BridgeContract.BridgeContract_Transaction_Failed.selector);
        bridgeContract.bridge(token, amount);
    }
