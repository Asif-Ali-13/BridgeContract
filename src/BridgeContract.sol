...
contract BridgeContract is Ownable {
    error BridgeContract_Transaction_Failed();
    error BridgeContract_Insufficient_Allowance();
    ...
    function bridge(
        ...
        require(
            ...
            BridgeContract_Insufficient_Allowance()
        );
        require(
            _tokenAddress.transferFrom(_msgSender(), address(this), _amount),
            BridgeContract_Transaction_Failed()
        );
